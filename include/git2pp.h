...
#define LIBGIT2PP_VER_MINOR 0
#define LIBGIT2PP_VER_REVISION 1
#define LIBGIT2PP_XSTR(s) #s
#define LIBGIT2PP_STR(s) LIBGIT2PP_XSTR(s)
#define LIBGIT2PP_VERSION LIBGIT2PP_STR(LIBGIT2PP_VER_MAJOR) "." \
                          LIBGIT2PP_STR(LIBGIT2PP_VER_MINOR) "." \
                          LIBGIT2PP_STR(LIBGIT2PP_VER_REVISION)
