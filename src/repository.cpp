...
#define THROW(msg) throw Exception(QString("Repository::") + LIBGIT2PP_FUNC_NAME + "(): " + msg)
...
Reference Repository::createRef(const QString& name, const LibGit2pp::OId& oid, bool overwrite, const QString &message)
{
    git_reference *ref = 0;
